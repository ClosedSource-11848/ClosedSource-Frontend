...
export class Layout {
  ...
  options = [
    ...
    },
    {
      ...
      link: '/ra',
      children: [
        { label: 'kpi-dashboard.title', link: '/ra/kpi-dashboard' },
        { label: 'deviation-trend.title', link: '/ra/deviation-trends' },
        { label: 'report-generator.title', link: '/ra/report-generator' },
        { label: 'audit-log.title', link: '/ra/audit-log' },
      ],
    },
    {
