...
const labProfile = () =>
  import('./views/lab-profile/lab-profile').then((m) => m.LabProfile);

const staffList = () =>
  import('./views/staff-list/staff-list').then((m) => m.StaffList);

const staffForm = () =>
  import('./views/staff-form/staff-form').then((m) => m.StaffForm);
